package com.example.join_mapping_pg;
...
public class App 
{
    public static void main( String[] args )
    {
    	try(ConfigurableApplicationContext context 
        	...
        	MeetingRoom meetingRoom = meetingRoomService.selectJoinMeetingRoom("A-001");
        	System.out.println("findOne(A-001): " + meetingRoom);
        	
        	meetingRoom = meetingRoomService.selectJoinMeetingRoom("A-003");
