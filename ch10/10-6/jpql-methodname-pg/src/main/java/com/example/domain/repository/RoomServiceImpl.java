...
public class RoomServiceImpl implements RoomService {
	...
	public List<Room> findByRoomNameAndCapacity(String roomName, Integer capacity) {
		return roomRepository.findByRoomNameAndCapacity(roomName, capacity);
	}

	@Transactional(readOnly = true)
	@Override
	public List<Room> findDistinctRoomByEquipments_EquipmentName(String equipmentName) {
		return roomRepository.findDistinctRoomByEquipments_EquipmentName(equipmentName);
	}

	@Override
	public List<Room> findByCapacityBetween(Integer capacityFrom, Integer capacityTo) {
		return roomRepository.findByCapacityBetween(capacityFrom, capacityTo);
	}
