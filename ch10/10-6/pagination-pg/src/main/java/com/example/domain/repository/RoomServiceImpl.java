...
public class RoomServiceImpl implements RoomService {
	...
	@Transactional(readOnly = true)
	@Override
	public List<Room> searchRoomByNameLikeAsc(String roomName, int page, int size) {
		Sort sort = new Sort(Direction.ASC, "roomName");
		// 2018.12.24 change: deprecated
		//Pageable pageable = new PageRequest(page, size, sort);
		Pageable pageable = PageRequest.of(page, size, sort);
		Page<Room> rooms = roomRepository.findByRoomNameLike(roomName, pageable);
