...
public class FileUploadController {
	...
	public CompletableFuture<String> upload(@Validated FileUploadForm form, BindingResult result) throws IOException {
		...
		CompletableFuture<String> future = asyncHelper.asyncUploading(form.getPsudoError(), file);
